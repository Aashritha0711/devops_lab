...
exp_d = [32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13,
         ...
         32, 1]
per = [16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5, 18, 
...
def sbox_substitution(six_bits, box):
...
def encrypt(pt_hex, round_keys):
    ...
    for i in range(16):
        ...
        #     sbox_str += sbox_substitution(six_bits, sbox[j])
        sbox_perm = permute(xored, per)
        result = xor(left, sbox_perm)
...
plaintext = input("Enter the 16-hex-digit plaintext: ")
